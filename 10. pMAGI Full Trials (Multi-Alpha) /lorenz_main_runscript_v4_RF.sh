#!/bin/bash
#SBATCH -J LM4RFMA # A single job name for the array
#SBATCH -n 1 # Number of cores
#SBATCH -N 1 # All cores on one machine
#SBATCH -p sapphire,shared # Partition
#SBATCH --mem 16000 # Memory request (16 GB)
#SBATCH -t 0-04:00 # (D-HH:MM)
#SBATCH -o /n/holyscratch01/kou_lab/swu/camera_ready/10_pMAGI+MAGI_full-trials_mult-alpha/outputs/LMRFMA_%j.out # Standard output
#SBATCH -e /n/holyscratch01/kou_lab/swu/camera_ready/10_pMAGI+MAGI_full-trials_mult-alpha/errors/LMRFMA_%j.err # Standard error
