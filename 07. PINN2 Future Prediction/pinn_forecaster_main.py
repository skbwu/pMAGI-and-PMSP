...
curves_sample = pinn.predict_curves(lorenz_data[0], TM, TFC, is_forecasting=False)
...
# store our TM_vals
pinn.store_TM_vals(Xhat_ts_sample[-1])

# toggle the lmbda to have zero L2 reconstruction error weight
pinn.lmbda = 0.0
...
curves_forecast = pinn.predict_curves(ts_forecast, TM, TFC, is_forecasting=True)
